        ...
        {[1, 2, 3, 4, 5].map((i) => (
          <div
            ...
            style={{
              ...
              height: 8,
              borderRadius: "50%",
              background: i <= level ? T.spice[level] : T.bg3,
...
function DietBadges({ dish }) {
  const badges = [];
  if (dish.isVeg)
    badges.push(<Badge key="veg" icon="●" label="VEG" bg="#052e16" color="#4ade80" />);
  else
    badges.push(<Badge key="nv" icon="●" label="NON-VEG" bg="#2d0a0a" color="#f87171" />);
  if (dish.containsEgg)
    badges.push(<Badge key="egg" icon="🥚" label="EGG" bg="#1c1a05" color="#facc15" />);
  if (dish.containsDairy)
    badges.push(<Badge key="dairy" icon="🥛" label="DAIRY" bg="#071a2e" color="#60a5fa" />);
  if (dish.containsGluten)
    badges.push(<Badge key="gluten" icon="🌾" label="GLUTEN" bg="#1c0f05" color="#fb923c" />);
  if (dish.containsNuts)
    badges.push(<Badge key="nuts" icon="🥜" label="NUTS" bg="#17082a" color="#c084fc" />);
  if (dish.containsSeafood)
    badges.push(<Badge key="sea" icon="🦐" label="SEAFOOD" bg="#071418" color="#22d3ee" />);
  if (dish.containsMeat)
    badges.push(<Badge key="meat" icon="🥩" label="MEAT" bg="#2d0a0a" color="#fb7185" />);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span style={{ fontSize: 11, color: T.amberDim, fontWeight: 700 }}>
        ...
        <div style={{ padding: "0 16px 18px", borderTop: `1px solid ${T.bg3}` }}>
          <div
            style={{
              ...
              border: `1px solid ${T.amberDim}40`,
              borderRadius: 14,
              padding: "12px 14px",
              marginTop: 14,
              display: "flex",
          ...
          {dish.pairsWith && (
            ...
            >
              ...
              <div>
                ...
                <p style={{ fontSize: 13, color: T.text2, margin: "2px 0 0" }}>
                  {dish.pairsWith}
                </p>
              </div>
            </div>
...
function Camera({ onCapture, onClose }) {
  ...
  const capture = () => {
    ...
    onCapture(preview.split(",")[1], preview, "image/jpeg");
  };
...
function Scanning({ preview }) {
  const steps = [
    ...
    "Reading every dish name…",
    "Researching dish information…",
    "Analysing ingredients & allergens…",
    "Building your menu guide…",
  ];
  const [step, setStep] = useState(0);

  useEffect(() => {
    const t = setInterval(() => setStep((s) => Math.min(s + 1, steps.length - 1)), 1700);
        ...
        >
          ...
          <div
            style={{
              position: "absolute",
              inset: 0,
              background: "linear-gradient(180deg, transparent 60%, rgba(12,10,9,0.7))",
            }}
          />
        </div>
      )}
        ...
        {steps.map((s, i) => (
          <div
            ...
            style={{
              ...
              borderRadius: 14,
              marginBottom: 6,
              background: i === step ? `${T.amber}12` : "transparent",
              border: `1px solid ${i === step ? T.amber + "40" : "transparent"}`,
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div>
            <p style={{ fontWeight: 800, fontSize: 18, color: T.text1, margin: 0 }}>
              🗣️ Traveler Phrases
            </p>
            <p style={{ fontSize: 12, color: T.text3, margin: "3px 0 0" }}>
              Tap Copy — shows Hindi & speaks it aloud
            </p>
          </div>
          <button
            onClick={onClose}
          ...
          {PHRASES.map((p, i) => (
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <p style={{ fontSize: 11, color: T.amberDim, fontStyle: "italic", margin: 0 }}>
                  {p.ph}
                </p>
              </div>
              <button
                ...
                style={{
                  background: copied === i ? "#14532d" : T.amberBg,
                  border: `1px solid ${copied === i ? T.green : T.amberDim}`,
                  color: copied === i ? T.green : T.amber,
                  borderRadius: 12,
                  padding: "8px 14px",
                  fontSize: 12,
                  fontWeight: 800,
        ...
        <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              <div
                style={{
                  ...
                  borderRadius: 22,
                  background: T.amberBg,
                  border: `1.5px solid ${T.amberDim}40`,
                  marginBottom: 20,
                  fontSize: 36,
                }}
              >
              ...
              >
                Never lost
                <br />
                <span style={{ color: T.amber }}>on a menu</span> again.
              </h1>
              ...
              >
                Scan any Indian menu in any script. AI reads the language, researches every dish,
                and gives you the full guide instantly.
              </p>
              ...
              <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
                <button
                  ...
                  style={{
                    ...
                    alignItems: "center",
                    gap: 9,
                    boxShadow: `0 4px 32px ${T.amber}40`,
                  }}
                >
                  📷 Open Camera
                </button>
          ...
          {error && (
            ...
            >
              ...
              <div>
                ...
                <p style={{ color: "#f87171", fontSize: 13, marginTop: 3, lineHeight: 1.6 }}>
                  {error}
                </p>
              </div>
            </div>
            ...
            {[
              {
                icon: "📷",
                t: "Scan or Upload",
                d: "Any photo of any Indian menu — any language, any handwriting",
              },
              {
                icon: "🔍",
                t: "AI Detects Language",
                d: "Identifies script automatically: Hindi, Bengali, Tamil, Telugu, and 6 more",
              },
              {
                icon: "🌐",
                t: "AI Researches Every Dish",
                d: "Looks up ingredients, origin, spice level, allergens, cultural context",
              },
              {
                icon: "✨",
                t: "Your Full Guide",
                d: "Pronunciation, food description, pairing suggestions, traveler tips",
              },
            ].map((s) => (
              <div
                key={s.t}
              ...
              >
                ...
                <div>
                  ...
                  <p style={{ fontSize: 13, color: T.text2, marginTop: 3, lineHeight: 1.55 }}>
                    {s.d}
                  </p>
                </div>
              </div>
          ...
          <div style={{ padding: "0 20px 16px" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 8 }}>
              {[
                ...
                { n: "Telugu", s: "తెలుగు" },
                { n: "Kannada", s: "ಕನ್ನಡ" },
                { n: "Malayalam", s: "മലയാളം" },
                { n: "Marathi", s: "मराठी" },
                { n: "Gujarati", s: "ગુજરાતી" },
                { n: "Punjabi", s: "ਪੰਜਾਬੀ" },
              ].map((s) => (
                <div
                  key={s.n}
                ...
                >
                  ...
                  <p style={{ fontSize: 11, color: T.text2, fontWeight: 600, marginTop: 3 }}>
                    {s.n}
                  </p>
                </div>
              ))}
          ...
          <div style={{ padding: "0 20px 48px" }}>
            ...
            >
              ...
              <span style={{ fontSize: 12, fontWeight: 500, color: `${T.teal}80` }}>
                10 essential Hindi phrases
              </span>
            </button>
          </div>
        </div>
      ...
      {screen === "results" && results && (
        <div style={{ minHeight: "100vh", background: T.bg0 }}>
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <p style={{ fontWeight: 800, fontSize: 15, color: T.text1, margin: 0 }}>
                Menu Translated
              </p>
              <p style={{ fontSize: 11, color: T.text3, margin: "1px 0 0" }}>
                {results.detectedLanguage} · {results.dishes?.length} dishes
              </p>
            </div>
          ...
          <div
            style={{
              background: `linear-gradient(135deg, ${T.amberBg}, ${T.bg2})`,
              borderBottom: `1px solid ${T.border}`,
              padding: "16px 18px",
              display: "flex",
              alignItems: "center",
          ...
          >
            <div style={{ flex: 1 }}>
              ...
              <p style={{ color: T.amber, fontWeight: 800, fontSize: 17, marginTop: 1 }}>
                {results.detectedScript || results.detectedLanguage}
              </p>
            ...
            <div style={{ textAlign: "right" }}>
              <p style={{ color: T.text1, fontWeight: 900, fontSize: 36, lineHeight: 1 }}>
              ...
              {FILTERS.map((f) => (
                <button
                  ...
                  style={{
                    ...
                    cursor: "pointer",
                    background: filter === f ? T.amber : T.bg1,
          ...
          <div style={{ padding: "8px 16px 120px", display: "flex", flexDirection: "column", gap: 12 }}>
            {filtered.length === 0 ? (
              <div style={{ textAlign: "center", padding: "56px 20px", color: T.text3 }}>
                ...
                <p style={{ fontWeight: 700, marginTop: 16, color: T.text2 }}>
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                fontWeight: 800,
                cursor: "pointer",
                boxShadow: `0 4px 20px ${T.amber}30`,
              }}
            >
              🗣️ Phrases
            </button>
